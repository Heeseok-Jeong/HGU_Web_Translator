...
현재 이용되고 있는 번역기들은 고유명사를 인식하는데 어려움을 겪고 있다. 본 연구는 Backbone NMT (Neural Machine Translation) 에 **고유명사 사전과 기호화**를 적용하여 기존의 한/영 번역기에서 “바람과 함께 사라지다” 같은 고유명사를 “Gone With The Wind” 가 아닌 “Vanish With The Wind” 로 번역하는 문제점을 해결하고자 한다.
